...
describe HopstopDirections do
  ...
  describe '.parse_steps' do
    ...
    it 'combines sets of related steps into a single step' do
      ...
      parsing[4]['duration'].should == 300 + 94 + 88 + 94 + 95 + 111 + 83 + 83
